...
const burgerActive = () => {
  ...
  if (menu_b.classList.contains('active')) {
    nav.style.display = 'block'; // Show the navigation links
...
// Ensure ScrollReveal is included in your project
...
window.addEventListener('scroll', scollActive);
 ...
 const typed = new Typed('.multiple',{strings:["Dévelopeur Web", "Designer", "Createur "],
     typeSpeed: 100,
     backSpeed: 100,
     backDelay: 1000,
     });
